...
select st.student_id, st.student_name, en.enrollment_id, course_name from students as st
join enrollments as en
on st.student_id=en.student_id;

select st.student_id, st.student_name, st.major, en.enrollment_id, en.course_name from students as st
...
select st.student_name,st.student_id,count(en.enrollment_id) from students as st
join enrollments as en
on st.student_id=en.student_id
group by st.student_id;

select count(student_id), major from students 
group by major;
...
select char_length(st.student_name), count(st.student_id), count(en.enrollment_id) from students as st
join enrollments as en
on st.student_id=en.student_id
